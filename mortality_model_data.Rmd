...
# WORKING - fix extra rows w/ outcome=1
...
tabUnweighted <- CreateTableOne(vars = vars, strata = "transplant", data = df_final, test = FALSE)
...
## Split data into training / testing sets - START HERE
